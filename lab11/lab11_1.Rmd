...
homerange %>% 
  ggplot(aes(x = log10.mass)) +
  geom_histogram(alpha= 2, color = "honeydew2", fill = "cornsilk", bins=40)+
  labs(title = "Distribution of Body Mass") #alpha is the transparency of the color
#color is the boundary/border color 
#bin is the width of the bars 
```
...
homerange %>% 
  ggplot(aes(x = log10.mass)) +
  geom_density(fill="orchid2", alpha  =0.4, color = "black")+
  labs(title = "Distribution of Body Mass")
```
...
homerange %>% 
  ggplot(aes(x=log10.mass)) +
  geom_histogram(aes(y = ..density..), fill = "papayawhip", alpha = 0.4, color = "black")+
...
homerange %>% 
 ggplot(aes(x = log10.hra)) +
  geom_histogram(alpha= 2, color = "plum3", fill = "lavenderblush")+
...
homerange %>% 
  ggplot(aes(x = log10.hra)) +
  geom_density(fill="lavenderblush", alpha  =0.4, color = "plum3")+
  labs(title = "Distribution of Homerange")
```
...
```{r}
homerange %>% 
  ggplot(aes(x = log10.hra, y=..density..)) +
  geom_histogram(alpha= 2, color = "plum3", fill = "lavenderblush", bins=40)+
   geom_density(fill="steelblue2", alpha  =0.4, color = "plum3")
  labs(title = "Distribution of Homerange")
```
