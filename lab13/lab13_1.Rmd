...
inner_exampleDF #giving you output of what R sees are in common, perfectly fitting, removing the others that do not match
```
...
left_exampleDF #takes table on the left
```
...
anti_exampleDF #telling you what will be lost 
```
