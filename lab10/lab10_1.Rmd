...
elephants %>% 
  ...
  labs(title="Elephant Age vs.Height",
       x="Age",
       y="Height")+
  theme(plot.title=element_text(size=rel(1.25), hjust=1)) #hjust adjusts where the title will be located on the top ex: 0 is left, .5 middle, 1 is right ; rel is text size for title
```
